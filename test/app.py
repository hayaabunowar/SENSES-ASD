...
#GETTING CNN MODEL, TRAINING, AND DETECTION PATHS AND APPENDING THEM
CNN_Model = os.getcwd() + "\\" + "CNN"
CNN_Training = os.getcwd() + "\\" + "modelTraining"
Face_Detection = os.getcwd() +"\\"+ "faceDetection"
sys.path.append(CNN_Model)
sys.path.append(CNN_Training)
